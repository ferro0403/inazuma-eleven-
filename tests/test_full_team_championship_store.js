...
const championship = {
  id: "championship_1",
  name: "Championship 1",
  teams: [Store.fullTeamEntry(teams[0]), Store.fullTeamEntry(teams[1])],
...
const invalid = Store.normalizeChampionship({ name: "Bad", teams: [{ teamId: "raimon", playerIds: [] }, { teamId: "raimon", playerIds: [1, 9] }] });
